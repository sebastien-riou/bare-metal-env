...
build_artifact_name:=$(build_path)$(PROJECT_NAME)$(TARGET_ARTIFACT_EXT)
...
$(build_artifact_name).elf: $(OBJS)
	$(TARGET_CC) $(CFLAGS) -o $@ $^ $(LDFLAGS) $(LDEFS) $(LIBSINC) $(LIBS) $(SYMBOLS)
...
%.mem_dump: %.ihex
	$(PYTHON) $(csp_root)generic/scripts/ihex2ascii.py $< > $@
